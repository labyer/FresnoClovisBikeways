DROP FUNCTION IF EXISTS insert_bikeways_data(text,text,text);
...
BEGIN
    ...
    EXECUTE ' INSERT INTO table_16_093 (the_geom, description, name)
            VALUES ($1, $2, $3)
...
GRANT EXECUTE ON FUNCTION insert_bikeways_data(text,text,text) TO publicuser;
